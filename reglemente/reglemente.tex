...
\begin{reglemlista}
	...
	\begin{attlista}
		...
		\item informera styrelsemötet om kommande HMS-kommitémöten
		...
		\item att arbeta tillsammas med studierådet för att verka mot en god studiemiljö
	\end{attlista}
...
%%% funktionar %%%
\funktionar{Årskursrepresentant för de tre lägre årskurserna samt masterprogrammet}
...
och samma person endast en gång. Denna medalj tillhandages till självkostnadspris
