...
\begin{reglemlista}
	...
	\begin{itemize}
		\item DELTA
		\item Medlem i Projektgruppen för DELTA (erfoderligt antal)
	\end{itemize}
...
%%% funktionar %%%
\funktionar{Medlem i Projektgruppen för DELTA}

\begin{reglemlista}
	\item[Åligganden]
	Det åligger Medlem i Projektgruppen för DELTA
	\begin{attlista}
		\item bistå DELTA-generalen i dennes arbete
	\end{attlista}

	\item[Mandatperiod]
	Mandatperioden för Medlem i Projektgruppen för DELTA är 1 juli - 30 juni.
\end{reglemlista}
