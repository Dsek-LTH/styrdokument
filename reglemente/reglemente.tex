...
%%% funktionar %%%
\funktionar{Redaktör}
Redaktören ska sprida information via våra informationskanaler.
...
\begin{reglemlista}
	...
	\begin{attlista}
		\item bistå Informationsansvarig med att sprida relevant information från sektionens verksamhet och världen till sektionsmedlemmarna via sektionens informationskanaler
	\end{attlista}
