...
Kontoutdrag räknas inte. Utläggsräkningar ska ha inkommit till skattmästeriet inom 60 dagar från det att utgiften uppstått, om inte särskilda skäl föreligger.
Privata utlägg som inte inkommer inom denna tidsram och där särskilda skäl inte föreligger kommer inte att beaktas. Bedömningen av vad som utgör särskilda skäl sker enligt
